  ...
  return (
    <section className="relative h-screen overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: `url(https://www.apollotyres.com/content/dam/orbit/apollo-tyres-en-in/find-a-tyre/car-suv-find-a-tyre.jpg)`,
          height: "120%",
          top: "-10%",
        }}
      >
      ...
      >
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-light-200 mb-8 max-w-lg">
            Discover our comprehensive range of high-performance tyres designed to deliver superior grip, durability,
            and safety for all driving conditions.
          </p>
