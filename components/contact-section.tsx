      ...
      <div className="container mx-auto max-w-5xl">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-light-300">
            Ready to upgrade your tyres or need professional advice? Contact our expert team to find the perfect tyres
            for your vehicle or to schedule a fitting appointment at one of our service centers.
          </p>
        </div>
